...
<body>
    ...
    <script>
	    ...
	    if($("#userId").val() != ""){ 
	        $("#id_check").attr("checked", true); // ID 저장하기를 체크 상태로 두기.
	    }
	    
	    $("#id_check").change(function(){ // 체크박스에 변화가 있다면,
	        if($("#id_check").is(":checked")){ // ID 저장하기 체크했을 때,
	    ...
	    $("#userId").keyup(function(){ // ID 입력 칸에 ID를 입력할 때,
	        if($("#id_check").is(":checked")){ // ID 저장하기를 체크한 상태라면,
	            setCookie("key", $("#userId").val(), 7); // 7일 동안 쿠키 보관
	        }
	    });
